...
#implicit call
calc1 = Calculator(10,20)  #initialises values and calculator is not defined, returns None
#explicit call
...
class Calculator:
    ...
    def __init__(s, a, b):
        s.a = a            #public 
        s.__b = b          #private 
    def display(s):        #public method
        print(brand)       #brand is not defined, should be Calculator.brand
